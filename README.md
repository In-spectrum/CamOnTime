...
### &emsp;**Windows:**
- download installation files: <a href="https://gstreamer.freedesktop.org/data/pkg/windows/1.26.7/mingw/" target="_blank">gstreamer-1.0-mingw-x86_64-1.26.9.msi и gstreamer-1.0-devel-mingw-x86_64-1.26.9.msi</a>;
